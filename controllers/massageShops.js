...
exports.getMassageShops = async (req, res, next) => {
	...
	try {
		...
		res.status(400).json({ success: false, error: "cannot get massage shops" });
	}
};
...
exports.getMassageShop = async (req, res, next) => {
	try {
		...
		console.log(err.stack);
		res.status(500).json({ success: false, error: "cannot get massage shop" });
	}
};
...
exports.createMassageShop = async (req, res, next) => {
	try {
		...
		res
			.status(400)
			.json({ success: false, error: "cannot create massage shop" });
	}
};
...
exports.updateMassageShop = async (req, res, next) => {
	try {
		...
		res
			.status(400)
			.json({ success: false, error: "cannot update massage shop" });
	}
};
...
exports.deleteMassageShop = async (req, res, next) => {
	try {
		...
		res
			.status(400)
			.json({ success: false, error: "cannot delete massage shop" });
	}
};
